    ...
    <section className='max-container padding-container flex flex-col gap-20 py-5 md:gap-28 lg:py-5 xl:flex-row'>
        <div className='flex flex-col gap-20'>
            ...
            <div className='flex gap-10 font-bold'>
                <Link className='underline-hover-socials socials facebook' href="https://www.facebook.com/your_facebook_page">
                    Facebook
                </Link>
                <Link className='underline-hover-socials socials instagram' href="https://www.instagram.com/your_instagram_page">
                    Instagram
                </Link>
                <Link className='underline-hover-socials socials whatsapp' href="https://wa.me/995593220038">
                    WhatsApp
                </Link>
                <Link className='underline-hover-socials socials telegram' href="https://te.me/">
                    Telegram
                </Link>
            </div>
        </div>
